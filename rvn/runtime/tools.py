"""Resolve rvn-managed runtimes before falling back to PATH."""
...
def resolve(name: str) -> str | None:
    """Return an absolute path to *name*, preferring rvn-managed runtimes."""
...
def require(name: str, *, install_kind: str) -> str:
    ...
    hint = (
        f"  Install it via rvn: rvn runtime install {install_kind} <version>\n"
