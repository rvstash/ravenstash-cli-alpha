...
Include the `rvs --version` output, operating system and architecture, the
command you ran, and a minimal sanitized reproduction. Remove access tokens,
repository credentials, package contents, and personal information from logs.
